...
@rem ##########################################################################
@rem
@rem  PodcastApp startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and PODCAST_APP_OPTS to pass JVM options to this script.
...
:fail
rem Set variable PODCAST_APP_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%PODCAST_APP_EXIT_CONSOLE%" exit 1
exit /b 1
